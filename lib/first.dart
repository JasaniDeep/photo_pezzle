...
class _fristState extends State<frist> {
  List imglist=["a.png","b.png","c.png","a.png","b.png","c.png"];
        ...
        return InkWell(
          ...
          child: Visibility(
            visible: visiblelist[index],
              replacement: Container(height: 100,width: 100,color: Colors.black,),
              child: Image.asset("image/${imglist[index]}",height:100,width: 100,)
          ),
        );
      },gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3,childAspectRatio: 2,crossAxisSpacing: 10,mainAxisSpacing: 10),itemCount: imglist.length, ),
    );
  }
}
